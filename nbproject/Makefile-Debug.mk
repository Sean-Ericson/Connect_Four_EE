...
${OBJECTDIR}/Connect_Four_Game.o: Connect_Four_Game.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSFML_STATIC -I../../../../../SFML-2.1/include -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Connect_Four_Game.o Connect_Four_Game.cpp

${OBJECTDIR}/Connect_Four_Graphics.o: Connect_Four_Graphics.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSFML_STATIC -I../../../../../SFML-2.1/include -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Connect_Four_Graphics.o Connect_Four_Graphics.cpp

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -DSFML_STATIC -I../../../../../SFML-2.1/include -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
